<div class="panel">
	...
	<div class="panel_body">
		...
		<div>
			...
			<?php echo $form->textField($model,"device_brand_name",array("size" => 80));?>
		</div>
		<div>
			<?php echo $form->labelEx($model,"device_code");?>
			<?php echo $form->textField($model,"device_code",array("size" => 80));?>
		</div>
		<div>
			<?php echo $form->labelEx($model,"device_price");?>
			<?php echo $form->textField($model,"device_price",array("size" => 80));?>
		</div>
		<div>
			<?php echo $form->labelEx($model,"device_buy_date");?>
			<?php echo $form->textField($model,"device_buy_date",array("size" => 10));?>
		</div>
		<div>
			<?php echo $form->labelEx($model,"device_garantee_expire_date");?>
			<?php echo $form->textField($model,"device_garantee_expire_date",array("size" => 10));?>
		</div>
		<div>
			<label></label>
