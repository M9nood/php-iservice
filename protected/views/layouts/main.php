...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $baseUrl; ?>/css/easyui.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo $baseUrl; ?>/css/icon.css" />
